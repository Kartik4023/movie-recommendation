...
def on_submit():
    ...
    if result_text:
        ...
        result.config(
            text="No movies found with the provided genres.",
            justify="left",
            fg="#333",
            font=("Arial", 12),
            padx=10,
...
label = tk.Label(
    root,
    text="Enter your preferred genres (comma-separated):",
    bg="#F5F5F5",
    fg="#333",
    font=("Arial", 12),
)
...
categories_list = tk.Label(
    root,
    text="Drama, Crime, Action, Romance, Adventure, Sci-Fi, Thriller, Comedy, Horror, Animation",
    bg="#F5F5F5",
    fg="#333",
    font=("Arial", 12),
)
